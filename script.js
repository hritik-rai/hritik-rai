    ...
    projectsContainer.innerHTML = config.projects.map(project => `
        <div class="project-card p-6 rounded-lg hover:scale-105 transition-all duration-300 group">
            ...
            <div class="flex space-x-4">
                <a href="${project.github}" class="flex items-center space-x-2 text-gray-300 hover:text-white transition-colors text-sm font-mono">
                ...
                <a href="${project.demo}" class="flex items-center space-x-2 text-python-yellow hover:text-white transition-colors text-sm font-mono">
...
function handleContactForm(e) {
    ...
    setTimeout(() => {
        alert(`Thank you ${name}! Your message has been sent. (This is a demo - integrate with your backend)`);
        e.target.reset();
